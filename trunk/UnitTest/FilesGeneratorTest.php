...
class FilesGeneratorTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$p = new Project();
		$p->setProjectFolder("O:\\wwwroot\\TestDao");
		$p->setDaoFolder("dao1");
		$t = new Table();
		$t->setName("a");
		$c = new Column();
...
// 		$cu->setAutoGenerate();
		...
		FilesGenerator::GO($p);
		$this->assertTrue(file_exists("O:\\wwwroot\\TestDao\\dao\\dao.xml"));
	...
	function testReadProject()
	{
 		$content = '<?xml version="1.0" encoding="UTF-8"?>
 				<project name="ELektronicznyNadawca1" dataSourceImplementation="DBEN" author="">
 		...
 		$h = fopen("O:\\wwwroot\\TestDao\\dao1\\dao.xml", "w");
 		fwrite($h, $content);
 		fclose($h);
