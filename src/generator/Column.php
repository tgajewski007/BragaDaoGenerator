...
class Column
{
	...
	protected $databaseGenerated = false;
// -------------------------------------------------------------------------
	public function setDatabaseGenerated(bool $generated = true)
	{
		$this->databaseGenerated = $generated;
	}
// -------------------------------------------------------------------------
	public function isDatabaseGenerated(): bool
	{
		return $this->databaseGenerated;
	}
	// -------------------------------------------------------------------------
	...
	static function import(\DOMElement $c)
	{
		...
		$t->setDatabaseGenerated((bool)$c->getAttribute("databaseGenerated"));
		return $t;
	}
	// -------------------------------------------------------------------------
	public function export(\DOMElement $c)
	{
		...
		$c->setAttribute("databaseGenerated", var_export($this->isDatabaseGenerated(), true));
	}
	// -------------------------------------------------------------------------
