...
class MySQLDAOFileGenerator extends DAOFileGenerator
{
	...
	protected function generateUpdate(Table $t)
	{
		...
		$this->addLine("{", 2);
		$this->addLine("\\braga\\graylogger\\BaseLogger::exception(new \\braga\\tools\\exception\\BragaException(\"SaveWithoutLock\", -1), \\Monolog\\Level::Critical, [ \"id\" => \$this->getKey(), \"class\" => \"" . $t->getClassName() . "\" ]);", 3);
		$this->addLine("}", 2);
